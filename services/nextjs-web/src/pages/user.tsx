...
export default function UserPage() {
  ...
  return (
    <div className="min-h-screen bg-dark-bg">
      {/* Header */}
      <header className="border-b bg-dark-input border-border-subtle">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
        ...
        {/* Profile Card */}
        <div className="rounded-lg border p-6 mb-6 bg-dark-card border-border-subtle shadow-md">
        ...
        <div className="flex flex-wrap gap-3">
          <button className="flex items-center gap-2 px-4 py-2 text-sm rounded border cursor-pointer border-border-subtle text-text-secondary hover:bg-dark-card transition-colors">
            <Settings size={14} />
            Settings
          </button>
...
function QuickActionCard({ icon: Icon, title, description }: QuickActionCardProps) {
  return (
    <div className="rounded-lg border p-5 cursor-pointer bg-dark-card border-border-subtle shadow-md hover:border-white/10 transition-colors">

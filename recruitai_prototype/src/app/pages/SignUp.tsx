    ...
    >
      <div className="w-full max-w-sm">
        ...
        >
          ...
          <p className="text-center text-sm mb-8" style={{ color: '#7E8494', opacity: 0.7 }}>Join RecruitAI today</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <User size={15} className="absolute left-3 top-1/2 -translate-y-1/2" style={{ color: '#7E8494', opacity: 0.5 }} />
                <input
                  type="text"
                  value={form.name}
          ...
          <p className="text-center text-sm mt-6" style={{ color: '#7E8494', opacity: 0.7 }}>
            ...
            <Link to="/login" className="font-medium" style={{ color: '#7C6AEF' }}>
              Log In
            </Link>
          </p>
        </div>
